...
public class Lab_5_4 {
	...
	public static void main(String[] args) {
        ...
        driver.findElement(By.id("input-email")).sendKeys("abfcthnbfshjgiuggouawhoiawhdoiqwhnc@mail.com");
        driver.findElement(By.id("input-telephone")).sendKeys("9837664569");
        ...
        driver.findElement(By.xpath("//span[text()='Address Book']")).click();
